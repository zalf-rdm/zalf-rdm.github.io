...
For example, all DOI, which are provided by BonaRes Data Centre, have the prefix: 10.20387. Metadata can be associated with the object. 
...
More information is given by [Juha Hakala, 2010](http://www.persid.org/downloads/PI-intro-2010-09-22.pdf).
...
by Chavan and Penev (2011). Data publication in data journals are classified as “pure” publish data papers only
and journals classified as “mixed” publish both. 
...
This Open-Access infrastructure (EU - Funding Program Horizon 2020) explore publications and data sets, align policies,
link research and repositories, and train researchers for open science.
